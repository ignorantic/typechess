...
describe('Notation', () => {
  ...
  describe('UCIToSquare', () => {
    it('throw TypeError if square is invalid', () => {
      expect(() => UCIToSquare(0)).toThrowError();
      expect(() => UCIToSquare('b')).toThrowError();
      expect(() => UCIToSquare('7e')).toThrowError();
      expect(() => UCIToSquare('j1')).toThrowError();
      expect(() => UCIToSquare('e9')).toThrowError();
    });
